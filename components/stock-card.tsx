...
export default function StockCard({ stock }: { stock: StockData }) {
  ...
  const stockUrl = `https://finance.yahoo.com/quote/${stock.symbol}`

  return (
    <Link href={stockUrl} target="_blank" rel="noopener noreferrer">
      <Card className="hover:shadow-lg transition-shadow duration-300 overflow-hidden cursor-pointer hover:scale-105 transition-transform">
